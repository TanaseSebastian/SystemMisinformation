...
<video src="C:\Users\thema\Videos\4K Video Downloader\background.mp4" autoplay muted loop id="myVideo"></video>
 		 ...
 		 <p>MYSINFORMATION FIGHT SYSTEM collabora con enti esterni indipendenti che hanno in comune la lotta alle fake news</p>
  	     <div class="input-group mb-3">
  			...
  			<div class="input-group-append">
   				<input type="submit" class="btn btn-outline-secondary" name="UserAction" value = "Verifica Notizia" id="button-addon2" onsubmit = "showLoading()">
  			</div>
		</div>
	</div>
	...
	<div class="jumbotron">
 		 ...
 		 <p>Il sistema si occupa di verificare se la fonte è affidabile o meno</p>
  	     <div class="input-group mb-3">
  			...
  			<div class="input-group-append">
   				<input type="submit" class="btn btn-outline-secondary" name="UserAction" value = "Verifica Fonte" id="button-addon2" onClick = "showLoading()">
  			</div>
		</div>
	</div>
<script>
